...
export default defineNuxtConfig({
  ...
  i18n: {
    ...
    locales: [
      ...
      {
        code: 'xx', // code de langue à 2 lettres
        name: 'Xxxxx', // nom de la langue
        language: 'xx-XX', // code ISO de la langue
      },
    ],
  },
});
...
- Le répertoire `xx` à l'intérieur de `content` contient les traductions de vos fichiers de contenu, `xx` étant le code de la langue (par exemple, `fr/xxx.md` pour le français).
...
export default defineI18nConfig(() => ({
  ...
  messages: {
    en: {
      // ... ajoutez ici toutes les chaînes anglaises de navigation et d'interface ...
    },
    xx: {
      // ... ajoutez ici toutes les traductions de navigation et d'interface ...
    },
  },
}));
```
