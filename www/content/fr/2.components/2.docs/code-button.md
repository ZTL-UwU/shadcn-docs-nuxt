...
::field-group
  :field{name="code" type="string"}[Contenu du code à copier]
  :field{name="icon" type="string"}[Icône affichée avant le code]
  :field{name="variant" type="'default' | 'secondary' | 'destructive' | 'outline'" default-value="'outline'"}[Variante du bouton]
  :field{name="width" type="number"}[Largeur du bouton en pixels]
  :field{name="copyIcon" type="string" default-value="'lucide:copy'"}[Icône affichée avant la copie]
::
